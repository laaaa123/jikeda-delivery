...
import { createHashHistory, createMemoryHistory, createBrowserHistory } from 'E:/Projects/fuu-run/fuu-run-admin/fuu-run-admin/node_modules/@umijs/renderer-react';
