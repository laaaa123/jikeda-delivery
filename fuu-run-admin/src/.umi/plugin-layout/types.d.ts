...
/// <reference types="E:/fuu-run/fuu-run-admin/node_modules/@ant-design/pro-components" />


    import type { ProLayoutProps, HeaderProps } from "E:/fuu-run/fuu-run-admin/node_modules/@ant-design/pro-components";
